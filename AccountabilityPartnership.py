...
class AccountabilityPartnership:
    ...
    def log_today(
        ...
        if (
            ...
            # possibly redundant since disburse_points calls update_last_date_completed which saves partnership
            self.save_partnership()
    ...
    def disburse_points(self):  # should only be called when a log is successful
        ...
        # str() is necessary because it might be None
        if str(self.last_date_completed) != old_last_date_completed:
            points_to_add = 2
